...
import com.test.service.DownLoadFile;
import com.test.service.UpLoadFile;
...
public class Login {
    ...
    public static void sshSftp(String ip, String user, String psw, int port,
        ...
        try {
            ...
            Connection.ftpOperationService = new UpLoadFile();
            Connection.getChannel(session,sPath,dPath);
        } catch (Exception e) {
            e.printStackTrace();
        }
